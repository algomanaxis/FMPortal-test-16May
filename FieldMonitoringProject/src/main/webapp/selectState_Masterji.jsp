...
<body>
	...
	Connection con=null;
     ...
     try {
		...
		//	System.out.println("succesfully connected");
				...
				PreparedStatement ps1 =con.prepareStatement("SELECT DISTINCT(State) FROM `Masterji_DB`");
				ResultSet rs1=ps1.executeQuery();			
				  
				while(rs1.next()) {
					String nState=rs1.getString("State");
					state.add(nState);					
				}	
    ...
    <div class="container">
        <form action="allData_masterji.jsp" method="post">
           ...
           <input type="hidden" value="<%=webPage%>" name="surveyor" />         
