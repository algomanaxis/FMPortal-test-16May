...
<body>
	...
	<div class="topnav">
     ...
     try {		 
    	 	...
    	 	String webPage="Central DashBoard";
    ...
    <div class="container">
       <form action="centralDashBoard.jsp" method="post"> 
       <!--   <form action="casteSamlpingDemo.jsp" method="post">-->
...
function myFunction() {
  ...
  var demo1=document.getElementById("demo").innerHTML = "Please wait for 2-3 min.";
