...
/* 			Class.forName("com.mysql.cj.jdbc.Driver");
			...
			//System.out.println("came upto this"+vidhansabhaId);
			...
			//	System.out.println(min_value);
	            ...
	            //SELECT *  FROM `SAVE_SURVEY` WHERE `CHECKPOINT_ID` IN ('91858','92261') AND `VALUE` LIKE '%2-ASHISH ASWAL%' AND `DATETIME` LIKE '%2023-11-01%' ORDER BY `SID`  DESC
	...
	//System.out.println(min_value+" "+constFrName+" "+date);
