...
<body>
	...
	<!-- Navigation-->
	<div class="topnav">
	  <a class="active" href="#home">STDP</a>
	  <div id="rightNavBar">
    ...
    <div class="boxbar">
        ...
        <div class="buttons">      
      	 <a class="dashboard-button" href='SelectSurveyor_STDP.jsp?dept="<%=dept%>"'>FORM FILL</a>
         <a class="dashboard-button" href="generate_STDP.jsp"/>GENERATE STDP</a>           
        </div>
    </div>
