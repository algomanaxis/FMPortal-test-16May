...
<body>
	...
	<div class="topnav">
     ...
     <%
		String prjNameFP=request.getParameter("projectNameFP");	
        String prjNameBP=request.getParameter("projectNameBP");
        String prjName=prjNameFP+" "+"BP";
	%>
	<%
    ...
    <div class="container">
        ...
        <form id="myform" method="post" action="insert" >
            ...
            <input type="hidden" id="valueProject" name="projectNameFP" value="<%=prjNameFP%>" >
            <input type="hidden" id="valueProject" name="projectNameBP" value="<%=prjNameBP%>" >
