...
<%-- CG VS Election Study November 2023 BP
CG VS Election Study November 2023 FP  --%>
<%
		String prjName="CG VS Election Study November 2023 BP";
...
<% 
			...
			System.out.println(prjNamefp);
			System.out.println(prjNamebp);
			
		//	String prjNamefp="CG VS Election Study November 2023"+"FP";
		//	String prjNamebp="CG VS Election Study November 2023"+"BP";
			
			
			
		//	String prjNamefp=prjName.substring(0,size-2)
