...
<body>
	...
	PreparedStatement ps_sg_opp=null;
 	...
 	if(prj[prj.length-1].equals("FP"))
 	{
 		for(int i=0;i<prj.length-1;i++)
 		{
 			projNameopp+=prj[i]+" ";
 		}
 		projNameopp+="BP";
 	...
 	System.out.println(projNameopp);
     ...
     try {    	 
        ...
        // System.out.println("DON TILL 1");
    		...
    		//	System.out.println("succesfully connected");
    			...
    			PreparedStatement ps_opp =con.prepareStatement("SELECT *  FROM `CHECKLIST_MASTER` WHERE `CHECKLIST_NAME` LIKE ? LIMIT 1");
    			ps_opp.setString(1, projNameopp);
				ResultSet rs_opp=ps_opp.executeQuery();			
				  
				String chkListIdopp="";
				while(rs_opp.next()) {
					chkListIdopp  =rs_opp.getString("CHECKLIST_ID");
						 
				}
			    //System.out.println("chkListIdopp"+chkListIdopp);
		        ...
		        ps_sg_opp =con_sg.prepareStatement("SELECT *  FROM `mainapp_project` WHERE `capi_checklist_id` LIKE ?");
		        ps_sg_opp.setString(1,chkListIdopp);	
    			
    			rs_sg_opp=ps_sg_opp.executeQuery();
    			
    			
    			String newIdopp="";
    			while(rs_sg_opp.next()) {
    				newIdopp=rs_sg_opp.getString("id");
					 
				}
    			//System.out.println("newIdopp"+newIdopp);
		...
		//	Class.forName("com.mysql.cj.jdbc.Driver");
			...
			while(rs_sg.next()) {
				vidhansabhaIdopp=rs_sg.getString("checkpointid");		
			}
    	...
    	//System.out.println("vidhansabhaIdopp"+vidhansabhaIdopp);
  ...
  <!--to show FR of project -->	
   ...
   <div class="container">	
        <form action="villageVidhansabha.jsp" method="post">
           ...
           <input type="hidden" id="valueProject" name="projectNameopp" value="<%=projNameopp%>" >  
             ...
             <input type="hidden" id="valueProject" name="vidhansabhaIdopp" value="<%=vidhansabhaIdopp%>" >       
